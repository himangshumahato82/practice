          ...
          <AccordionItem id="div" mb="10px">
            <h2>
              <AccordionButton>
                <Box flex="1" textAlign="left">
                  <p className="filterhead">Room 's sort by Capacity</p>
                </Box>
                <AccordionIcon />
              </AccordionButton>
            </h2>
            <AccordionPanel pb={4}>
              <CheckboxGroup colorScheme="green">
                ...
                >
                  <Checkbox onChange={handleChange} value="Single Room">
                    <span className="checkboxtext">Single Room</span>
                  </Checkbox>
                  <Checkbox onChange={handleChange} value="Royal Suit">
                    <span className="checkboxtext">Royal Suit</span>
                  </Checkbox>
                  <Checkbox onChange={handleChange} value="Delux Suit">
                  <span className="checkboxtext">Delux Suit</span>
                </Checkbox>
                <Checkbox onChange={handleChange} value="Double Room">
                  <span className="checkboxtext">Double Room</span>
                </Checkbox>
